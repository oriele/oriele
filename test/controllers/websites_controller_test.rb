...
class WebsitesControllerTest < ActionController::TestCase
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post :create, website: { departament: @website.departament, details: @website.details, end: @website.end, name: @website.name, phone: @website.phone, start: @website.start, surname: @website.surname }
    end
  ...
  test "should update website" do
    patch :update, id: @website, website: { departament: @website.departament, details: @website.details, end: @website.end, name: @website.name, phone: @website.phone, start: @website.start, surname: @website.surname }
    assert_redirected_to website_path(assigns(:website))
  end
